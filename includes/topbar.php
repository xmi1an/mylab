        ...
        <ul class="navbar-nav ml-right">
            <li class="nav-item">
                <div class="text-center">
                    <h3 class="text-dark text-center">Welcome <?php echo ($row['labname']) ?> </h1>
                </div>
            </li>
        </ul>
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    //Fetching admin Name
                    $labid = $_SESSION['labid'];
                    $ret1 = mysqli_query($con, "select labname from labmaster where labid='$labid'");
                    while ($row1 = mysqli_fetch_array($ret1)) {

                    ?>

                        <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $row1['labname']; ?></span>
                    <?php } ?>
                    <img class="img-profile rounded-circle" src="../img/profile.png">
                </a>
                <!-- Dropdown - User Information -->
