...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">COWIN Lab</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            ...
            <a class="nav-link js-scroll-trigger" href="#about"><img src="img\covid19.png" alt="" srcset=""> About Coronavirus</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services"><img src="img\fever.png" alt="" srcset="">Covid-19 Symptoms</a>
          </li>
          <li class="nav-item">
  ...
  <header class="bg-dark text-white">
    <div class="container text-center">
      <h1>My Lab</h1>
      <p class="lead">Test kara do frendss</p>
    </div>

    <a href="laboratory\labsignup.php" class="btn btn-primary" role="button">Laboratory Signup</a>
    <a href="laboratory\lablogin.php" class="btn btn-primary" role="button">Laboratory Login</a>
  </header>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; My Lab 2022</p>
    </div>
    <!-- /.container -->
  </footer>
